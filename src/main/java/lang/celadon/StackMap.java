 ...
 */
@Beta
public class StackMap<K, V> implements SortedMap<K, V>, Serializable {
    ...
    /**
     * A list iterator over a StackMap.
     *
     * <P>
     * This class provides a list iterator over a StackMap. The
    ...
    public final class MapEntrySet
            implements SortedSet<Entry<K, V>>, Set<Entry<K, V>>, Collection<Entry<K, V>>, Serializable {
        private static final long serialVersionUID = 0L;
        ...
        public Entry<K, V> first() {
            if (size == 0)
                throw new NoSuchElementException();
            return new MapEntry(StackMap.this.first);
        }
        public Entry<K, V> last() {
            if (size == 0)
                throw new NoSuchElementException();
            return new MapEntry(StackMap.this.last);
        }
        @SuppressWarnings("unchecked")
    ...
    */
    ...
    /**
     * Given an array or varargs of replacement indices for this StackMap's iteration order, reorders this so the
     ...
     * <br>
     * This method modifies this StackMap in-place and also returns it for chaining.
     ...
     */
    public StackMap<K, V> reorder(int... ordering)
    {
